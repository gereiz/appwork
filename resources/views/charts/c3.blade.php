...
@section('styles')
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/c3/c3.css') }}">
@endsection

@section('scripts')
    <!-- Dependencies -->
    <script src="{{ asset('assets/vendor/libs/d3/d3.js') }}"></script>
    <script src="{{ asset('assets/vendor/libs/c3/c3.js') }}"></script>
    
    <script src="{{ asset('assets/js/charts_c3.js') }}"></script>
@endsection
