...
@section('styles')
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/flot/flot.css') }}">
@endsection

@section('scripts')
    <!-- Dependencies -->
    <script src="{{ asset('assets/vendor/libs/flot/flot.js') }}"></script>
    
    <script src="{{ asset('assets/js/charts_flot.js') }}"></script>
@endsection
