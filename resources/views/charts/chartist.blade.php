...
@section('styles')
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/chartist/chartist.css') }}">
@endsection

@section('scripts')
    <!-- Dependencies -->
    <script src="{{ asset('assets/vendor/libs/chartist/chartist.js') }}"></script>
    
    <script src="{{ asset('assets/js/charts_chartist.js') }}"></script>
@endsection
