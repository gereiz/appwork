...
@section('styles')
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/photoswipe/photoswipe.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/blueimp-gallery/gallery.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/blueimp-gallery/gallery-indicator.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/blueimp-gallery/gallery-video.css') }}">
@endsection

@section('scripts')
    <!-- Dependencies -->
    <script src="{{ asset('assets/vendor/libs/photoswipe/photoswipe.js') }}"></script>
    <script src="{{ asset('assets/vendor/libs/blueimp-gallery/gallery.js') }}"></script>
    <script src="{{ asset('assets/vendor/libs/blueimp-gallery/gallery-fullscreen.js') }}"></script>
    <script src="{{ asset('assets/vendor/libs/blueimp-gallery/gallery-indicator.js') }}"></script>
    <script src="{{ asset('assets/vendor/libs/blueimp-gallery/gallery-video.js') }}"></script>
    <script src="{{ asset('assets/vendor/libs/blueimp-gallery/gallery-vimeo.js') }}"></script>
    <script src="{{ asset('assets/vendor/libs/blueimp-gallery/gallery-youtube.js') }}"></script>
    
    <script src="{{ asset('assets/js/ui_lightbox.js') }}"></script>
@endsection
