...
@section('styles')
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/dragula/dragula.css') }}">
...
@section('scripts')
    <!-- Dependencies -->
    <script src="{{ asset('assets/vendor/libs/dragula/dragula.js') }}"></script>
...
@section('content')
    ...
    <ul class="sortable-example mb-5" id="sortable-1">
        <li style="background: #e9e9e9;">Item 1</li>
        <li style="background: #e9e9e9;">Item 2</li>
        <li style="background: #e9e9e9;">Item 3</li>
        <li style="background: #e9e9e9;">Item 4</li>
        <li style="background: #e9e9e9;">Item 5</li>
    </ul>
