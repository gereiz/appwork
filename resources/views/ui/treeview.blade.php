...
@section('styles')
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/jstree/themes/default/style.css') }}">
...
@section('scripts')
    <!-- Dependencies -->
    <script src="{{ asset('assets/vendor/libs/nestable/nestable.js') }}"></script>
    <script src="{{ asset('assets/vendor/libs/jstree/jstree.js') }}"></script>
    
    <script src="{{ asset('assets/js/ui_treeview.js') }}"></script>
@endsection
