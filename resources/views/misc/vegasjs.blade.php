...
@section('styles')
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/vegas/vegas.css') }}">
@endsection

@section('scripts')
    <!-- Dependencies -->
    <script src="{{ asset('assets/vendor/libs/vegas/vegas.js') }}"></script>
    
    <script src="{{ asset('assets/js/misc_vegasjs.js') }}"></script>
@endsection
