...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/dashboards_dashboard-3.js') }}"></script>
@endsection

@section('content')
    <h4 class="d-flex justify-content-between align-items-center py-2 mb-4">
        <div class="font-weight-bold">Shop Overview</div>
        <button type="button" class="btn btn-outline-primary rounded-pill">View reports</button>
    </h4>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="javascript:void(0)" class="text-body">PlayStation 4 1TB (Jet Black)</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="javascript:void(0)" class="text-body">Nike Men Black Liteforce III Sneakers</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="javascript:void(0)" class="text-body">Wireless headphones</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="javascript:void(0)" class="text-body">HERO ATHLETES BAG</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="javascript:void(0)" class="text-body">POÄNG</a>
                                </td>
                    ...
                    <div class="tab-pane fade" id="latest-sales">
                        <table class="table card-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <a href="javascript:void(0)" class="text-body">Apple iWatch (black)</a>
                                    </td>
                                    <td class="align-middle">1</td>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <a href="javascript:void(0)" class="text-body">WALKING 400 BLUE CAT3</a>
                                    </td>
                                    <td class="align-middle">2</td>
                ...
                <div class="card-body">
                    ...
                    <div class="pb-1 mb-3">
                        ...
                        <small class="text-muted">Created by
                            <a href="javascript:void(0)" class="text-body">Mike Greene</a> &nbsp;·&nbsp; 1 day ago</small>
                    </div>
                    ...
                    <div class="pb-1 mb-3">
                        ...
                        <br>
                        <small class="text-muted">Created by
                            <a href="javascript:void(0)" class="text-body">Leon Wilson</a> &nbsp;·&nbsp; 1 day ago</small>
                    </div>
                    ...
                    <div class="pb-1 mb-3">
                        ...
                        <br>
                        <small class="text-muted">Created by
                            <a href="javascript:void(0)" class="text-body">Allie Rodriguez</a> &nbsp;·&nbsp; 1 day ago</small>
                    </div>
                    ...
                    <div class="pb-1 mb-3">
                        ...
                        <br>
                        <small class="text-muted">Created by
                            <a href="javascript:void(0)" class="text-body"> Kenneth Frazier</a> &nbsp;·&nbsp; 1 day ago</small>
                    </div>
